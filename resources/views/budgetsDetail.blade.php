                                            ...
                                            <div class="_289Q">
                                                <div class="LB4I" style="margin: 0px -0.5rem;">
                                                    <div class="_3fS2 _1SIO _22vv _3Qdf _3wdJ" style="padding: 0.5rem;">
                                                        <span class="_1kYs">Giao dịch</span>
                                                    </div>
                                                            ...
                                                            <div class="LB4I _3J0T" style="margin: 0px -0.5rem;">
                                                                ...
                                                                <div class="LB4I YM-8" style="margin: 0px -0.5rem;">
                                                                    ...
                                                                    <div class="_3fS2 pwUH _15HY" style="padding: 0rem 0.5rem;">
                                                                        <div>
                                                                            <div class="absolute">Th10 24, 2021</div>
                                                                            <div class="_2OYk">5 ngày trước</div>
                                                                        </div>
                                                                    </div>
                    ...
                    <form action="">
                        <article class="_2ZwS _3U03 _2VOV">
                                    ...
                                    <div class="_2BJz">
                                        ...
                                        <div class="_2wfn">
                                            <div class="_2Gra required _1rNF">
                                                ...
                                                <div class="_1DjS required">
                                                    <div class="_3fMh">
                                                        <input class="_U5w" type="text" name="name" value="Tuấn">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="_2wfn">
                                            <div class="_2Gra required _1rNF">
                                                ...
                                                <div class="_1DjS required">
                                                    <div class="_3fMh">
                                                        <input class="_U5w" type="number" name="amount" step="0.01" inputmode="decimal" value="10000000">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="_2Gra required _1rNF">
                                                ...
                                                <div class="_1DjS required">
                                                    <div class="_3fMh">
                                                        <input type="text" disabled value="Vietnamese Đồng">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="_2axu">
                                ...
                                <div>
                                    <button class="_3WuR _1gOp" type="button">Xóa ngân sách</button>
                                </div>
                            </div>
                        </article>
                    </form>

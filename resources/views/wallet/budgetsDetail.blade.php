    ...
    <div class="ReactModalPortal">
        <div class="ReactModal__Overlay">
            <div class="ReactModal__Content ReactModal__Content--after-open _2RxW otWy" style="z-index: 1000;">
                <div class="_3EUw">
                    <form action="wallet/{{$wallet->id}}/budgetsDetail/fix/{{$budget->id}}" method="post">
                    {{csrf_field()}}
                        ...
                        <article class="_2ZwS _3U03 _2VOV">
                            ...
                            <div class="_2axu">
                                ...
                                <div>
                                    <a href="wallet/{{$wallet->id}}/budgetsDetail/delete/{{$budget->id}}" class="_3WuR _1gOp">Xóa ngân sách</a>
                                </div>
                            </div>
                        </article>
                    </form>
...
@section("script")
    ...
    <script src="src/js/wallet/budgetsDetail.js"></script>
    <script>

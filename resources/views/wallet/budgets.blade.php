                                            ...
                                            <div class="LB4I" style="margin: 0px -0.5rem;">
                                                <div class="_3fS2 o-cw _1ubS _1B3o" style="padding: 0.5rem;">
                                                    <a href="" class="_1MqG ">
                                                        <div draggable="true">
                                                            <article class="_2Ku2">
                                                                <h3 class="_3ow9">Tuấn</h3>
                                                                <span class="vBKU">Tất cả các ví</span>
                                                                <span class="_3JW3">
                                                                    <span>
                                                                        <span class="_2djs _2UNd">1,000,000.00 VND</span> 
                                                                        left
                                                                    </span>
                                                                </span>
                                                                <span class="_2f--">From 1,000,000.00 VND</span>
                                                                <div class="s0y4 _15eb">
                                                                    ...
                                                                    <div class="nKyy">
                                                                        <span>Th12 24, 2021</span>
                                                                        <span>Th01 23, 2022</span>
                                                                    </div>
                                                                </div>
                                                            </article>
                                                        </div>
                                        ...
                                        <div class="_2wfn">
                                            <div class="_2Gra required _1rNF">
                                                ...
                                                <div class="_1DjS required">
                                                    <div class="_3fMh">
                                                        <input class="_U5w" type="text" name="name" value="">
                                                    </div>
                                                    <div>

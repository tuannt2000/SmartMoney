                                    ...
                                    <div>
                                        <div class="UhKW">                                            
                                            ...
                                            <div class="_2jFV _1sxG">
                                                <div>
                                                    <span class="_1ypI">{{Auth::user()->email}}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="LB4I" style="margin: 0px -0.5rem;">
                                                ...
                                                <div class="_3fS2 o-cw _22vv _19wA _1KKs" style="padding: 0.25rem 0.5rem 0.5rem;">
                                                    <ul class="_2YRc _29hs">
                                                        <li class="_3nff _29hs">
                                                            <button class="_3xlp selected ">
                                                                <span>Ngày</span>
                                                            </button>
                                                        </li>
                                                        <li class="_3nff _29hs">
...
<script>
    ...
    const gradient = ctx2.createLinearGradient(0, 0, 0, 500);
    ...
    var myChart = new Chart(ctx2, {
        ...
        data: {
            ...
            datasets: [{
                ...
                pointBackgroundColor: "rgba(45, 186, 117)",
                pointHoverBackgroundColor: "rgba(45, 186, 117)",
                pointHoverBorderColor: "rgba(45, 186, 117)",
                pointBorderWidth: 3,
                pointHoverRadius: 4,

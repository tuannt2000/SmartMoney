                            ...
                            <div class="LB4I _3BdS">
                                <div class="_3fS2 _3cTs _3gPh _19wA _1B3o">
                                    <div class="_3wsj _1eTa">
                                        ...
                                        @if ($wallet->sum('initial_balance') + $outcome + $income == 0)
                                        <span class="_2Tip _39n0" style="color:#12c48b;">0.00 VND</span>
                                        @elseif ($wallet->sum('initial_balance') + $outcome + $income > 0)
                                        <span class="_2Tip _39n0" style="color:#12c48b;">+{{$wallet->sum('initial_balance') + $outcome + $income}} VND</span>  
                                        @else
                                        <span class="_2Tip _39n0" style="color:#f14c52;">{{$wallet->sum('initial_balance') + $outcome + $income}} VND</span>  
                                        @endif
                                    </div>
                                </div>
                                <div class="_3fS2 _3cTs _3gPh _19wA _1B3o">
                                    <div class="_3wsj _1eTa">
                                        ...
                                        @if ($outcome + $income == 0)
                                        <span class="_2Tip _39n0" style="color:#12c48b;">0.00 VND</span>
                                        @elseif ($outcome + $income > 0)
                                        <span class="_2Tip _39n0" style="color:#12c48b;">+{{$outcome + $income}} VND</span>  
                                        @else
                                        <span class="_2Tip _39n0" style="color:#f14c52;">{{$outcome + $income}} VND</span>  
                                        @endif
                                    </div>
                                </div>
                                <div class="_3fS2 _3cTs _3gPh _19wA _1B3o">
                                    <div class="_3wsj _1eTa">
                                        ...
                                        <span class="_2Tip _39n0" style="color:#12c48b;">0.00 VND</span> 
                                        @else
                                        <span class="_2Tip _39n0" style="color:#f14c52;">{{$outcome}} VND</span>  
                                        @endif
                                    </div>
                                </div>
                                <div class="_3fS2 _3cTs _3gPh _19wA _1B3o">
                                    <div class="_3wsj _1eTa">
                                        ...
                                        <span class="_2Tip _39n0" style="color:#12c48b;">0.00 VND</span> 
                                        @else
                                        <span class="_2Tip _39n0" style="color:#12c48b;">+{{$income}} VND</span>  
                                        @endif
                                    </div>
                                </div>
                            </div>
